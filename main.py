...
# ---------------- CONFIG (fill these) ----------------
TOKEN = "MTUwOTc3MDEwMDcxNzM5MTk2Mg.GncJ3O.EVjX6hZW1UsH0t1BBo5eedS057AbmDk3DF4ZVc"
GUILD_ID = 1505685866272526416  # your guild/server ID

# channels
TRANSACTIONS_ID = 1509772690633003118
MATCH_TIMES_CHANNEL_ID = 1509772804151578714
ASSIGNMENTS_CHANNEL_ID = 1509773133371150377
SCRIM_CATEGORY_ID = 0  # put your Scheduling category ID here, or 0 to create/use none
MATCH_SCORES_CHANNEL_ID = 1509772834610872391  # put your match-score channel ID here

# staff/team roles
CAPTAIN_ROLE_ID = 1509771839357059263
CO_CAPTAIN_ROLE_ID = 1509771855563587732
EXECUTIVE_ROLE_ID = 1509771795157483600
TEAM_PLAYER_ROLE_ID = 1509771875675279370

# assignment roles
HEAD_REF_ROLE_ID = 1509772091686387783
REF_ROLE_ID = 1509772103145230477
HEAD_CASTER_ROLE_ID = 1509772058018709675
CASTER_ROLE_ID = 1509772076821647440

FAQ_CHANNEL_ID = 1508713902026919936  # replace with the channel ID where FAQ should be posted
STREAM_WATCHER_ROLE_ID = 1509771929802899456  # 🎥 Stream Watcher
UNBORN_CAPTAIN_ROLE_ID = 1509772215909089310  # 🚀 Unborn Captain
EVENT_PING_ROLE_ID = 1509772257508200458    # 🎉 Event Ping
...
async def info(interaction: discord.Interaction):
    embed = discord.Embed(
        title="TTC Transactions Bot – Command Guide",
...
async def admin_info(interaction: discord.Interaction):
    ...
    embed = discord.Embed(
        title="TTC Transactions Bot – Admin Command Guide",
...
@bot.tree.command(
    guild=GUILD_OBJ,
    name="faq",
    description="Post the TTC FAQ and auto-role buttons (admins only)."
)
async def faq(interaction: discord.Interaction):
    ...
    text = (
        "# Tactical Tag Comp Asked Questions\n\n"
        ...
        "## • Application Forms\n\n"
        "> - TTC has a various list of positions and applications to better help the league!,\n"
...
async def code(interaction: discord.Interaction, team1: discord.Role, team2: discord.Role):
    ...
    await interaction.response.defer(ephemeral=True)
    code_value = f"TTC{random.randint(1000, 9999)}"
